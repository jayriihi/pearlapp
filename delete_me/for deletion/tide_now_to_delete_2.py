...
def format_date_time():
    ...
    now_str = dt.datetime.strftime(now_datetime,"%Y-%m-%dT%H:%M")
    now_str = ('2022-11-28T10:05')
    #create datetime objecet from datetime-local string from html input
    sesh_start_datetime = dt.datetime.strptime(now_str, '%Y-%m-%dT%H:%M')
    ...
    return string_start_time,  sesh_start_date_str, sesh_start_time_str, sesh_start_datetime, sesh_date, now_str
